...
class CurrentAccount extends Account {
    ...
    @Override
    public double calculateAnnualInterest() {
        // Typically current account has no interest;
        return 0.0;
    }
}
...
public class OnlineBankingSystem {
    public static void main(String[] args) throws InterruptedException {
        ...
        bank.createAccount(new SavingsAccount("S-1001", "Ryuga", 5000, 0.04));
        bank.createAccount(new CurrentAccount("C-2001", "Gojo", 2000, 1000)); // overdraft allowed

        // Concurrent transfers (Multithreading)
        Runnable t1 = () -> {
            try {
                bank.transfer("S-1001", "C-2001", 700);
            } catch (Exception e) {
        ...
        Runnable t2 = () -> {
            try {
                bank.transfer("C-2001", "S-1001", 500);
            } catch (Exception e) {
        ...
        // Balance check (Read)
        System.out.println("Balance S-1001: " + bank.checkBalance("S-1001"));
        System.out.println("Balance C-2001: " + bank.checkBalance("C-2001"));

        // interest calculation differs by account type
        Account a1 = bank.getAccount("S-1001");
        Account a2 = bank.getAccount("C-2001");
        System.out.println("Annual interest S-1001: " + a1.calculateAnnualInterest());
        System.out.println("Annual interest C-2001: " + a2.calculateAnnualInterest());

        // Transaction history (Read)
        System.out.println("\nTransaction History S-1001:");
        for (Transaction tx : bank.getTransactionHistory("S-1001")) {
            System.out.println(tx);
        }

        System.out.println("\nTransaction History C-2001:");
        for (Transaction tx : bank.getTransactionHistory("C-2001")) {
            System.out.println(tx);
        }
    }
}
