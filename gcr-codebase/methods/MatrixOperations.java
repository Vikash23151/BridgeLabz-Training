...
public class MatrixOperations {
    ...
    public static void main(String[] args) {
        // Demonstration of Addition and Subtraction (Must be same size)
        System.out.println("=== Addition & Subtraction (3x3 Matrices) ===");
        ...
        // Demonstration of Multiplication (Rectangular)
